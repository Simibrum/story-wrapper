...
Author - Jonathan Reeve from https://github.com/JonathanReeve/gitenberg-experiments/blob/master/parseRDF.py
...
META_FIELDS = (
	...
	'authoryearofbirth', 'authoryearofdeath', 'language'
)
NS = dict(
...
def parsemetadata(ebook):
	...
	# formats
	result['formats'] = {
		file.find('{%(dc)s}format//{%(rdf)s}value' % NS).text:
